...
function materialEtaLine(profile: PlannerProfile, id: MaterialId, context: EstimateContext) {
  ...
  return `${etaText(estimate.days)} no ritmo de ${formatRate(materialRate(profile, id, context.competitors).perDay)}${coins}`;
}
