...
export const MATERIALS: MaterialDefinition[] = [
  {
    ...
    crowPrice: 200,
    sources: [
      { type: "weekly", label: "[Semanal] Para o bem dos jovens Vendedores Lontras", detail: "Recompensa x15 no Olho de Okilua." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante I", detail: "Escolha de recompensa x4; alternativa à Pequena Retribuição II." },
      { type: "weekly", label: "[Semanal] Caçador de Kandidum", detail: "Escolha de recompensa x4." },
  ...
  },
  {
    ...
    crowPrice: 40,
    sources: [
      { type: "daily", label: "[Permuta][Diário] Ilha de Iliya Agitada", detail: "Recompensa x10 ao concluir 15 permutas." },
  ...
  },
  {
    ...
    crowPrice: 80,
    sources: [
      { type: "weekly", label: "[Semanal] Para o bem dos jovens Vendedores Lontras", detail: "Recompensa x45 no Olho de Okilua." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante I", detail: "Escolha de recompensa x8; alternativa à Pequena Retribuição II." },
      { type: "barter", label: "Permuta de Mercadoria Marítima [Nível 4]", detail: "Pode aparecer nas rotas de material de navio." },
  ...
  },
  {
    ...
    crowPrice: 200,
    sources: [
      { type: "daily", label: "[Permuta][Diário] Ilha de Iliya Agitada", detail: "Recompensa x2 ao concluir 15 permutas." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante I", detail: "Escolha de recompensa x4; alternativa à Pequena Retribuição II." },
      { type: "hunt", label: "Criaturas Marinhas", detail: "Pode ser obtido eliminando criaturas marinhas." },
  ...
  },
  {
    ...
    crowPrice: 120,
    sources: [
      { type: "daily", label: "[Permuta][Diário] Transporte de Suprimentos (Olho da Okilua)", detail: "Dario entrega x2 na Ilha de Iliya." },
      { type: "daily", label: "Transporte de Suprimentos (Ilha de Iliya)", detail: "Croix entrega x1 em Velia." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] Preciso proteger pelo menos o meu corpo", detail: "Escolha de recompensa x3." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante II", detail: "Escolha de recompensa x6; alternativa à Pequena Retribuição I." },
      { type: "weekly", label: "[Semanal] Relatório de Aumento da População", detail: "Recompensa x2." },
      { type: "weekly", label: "[Semanal] Caçador de Dente de Aço Negro", detail: "Escolha de recompensa x6." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] Caçador de Rei do Mar Jovem da Lua Minguante", detail: "Recompensa x10." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante II", detail: "Escolha de recompensa x20; alternativa à Pequena Retribuição I." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] A guilda não é uma instituição de caridade", detail: "Escolha de recompensa x5." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante II", detail: "Escolha de recompensa x6; alternativa à Pequena Retribuição I." },
  ...
  },
  {
    ...
    crowPrice: 30,
    sources: [
      { type: "daily", label: "[Permuta][Diário] Ilha de Iliya Agitada", detail: "Recompensa x8 ao concluir 15 permutas." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante I", detail: "Escolha de recompensa x16; alternativa à Pequena Retribuição II." },
      { type: "hunt", label: "Criaturas Marinhas", detail: "Pode ser obtida eliminando criaturas marinhas." },
      { type: "barter", label: "Permuta de Mercadoria Marítima [Nível 3]", detail: "Pode aparecer nas rotas marítimas." },
  ...
  },
  {
    ...
    crowPrice: 400,
    sources: [
      { type: "daily", label: "[Permuta][Diário] Ilha de Iliya Agitada", detail: "Recompensa x1 ao concluir 15 permutas." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante I", detail: "Escolha de recompensa x2; alternativa à Pequena Retribuição II." },
      { type: "hunt", label: "Criaturas Marinhas", detail: "Pode ser obtido eliminando criaturas marinhas." },
      { type: "barter", label: "Permuta de Mercadoria Marítima [Nível 4]", detail: "Pode aparecer nas rotas marítimas." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "weekly", label: "[Semanal] Caçador de Nineshark", detail: "Escolha de recompensa x2." },
      { type: "daily", label: "[Diário] Pequena Retribuição da Guilda Lua Minguante II", detail: "Escolha de recompensa x2; alternativa à Pequena Retribuição I." },
      { type: "barter", label: "Permuta de Mercadoria Marítima [Nível 5]", detail: "Pode aparecer nas rotas marítimas." },
      { type: "crow", label: "Loja de Moeda Corvo", detail: "400 Moedas Corvo por unidade." },
    ],
  },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] A guilda não é uma instituição de caridade", detail: "Escolha de recompensa x1." },
      { type: "daily", label: "[Diário] Caçador de Kandidum da Guilda Lua Minguante", detail: "Escolha de recompensa x1." },
      { type: "weekly", label: "[Semanal] Caçador de Kandidum", detail: "Escolha de recompensa x1." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] Preciso proteger pelo menos o meu corpo", detail: "Escolha de recompensa x1." },
      { type: "daily", label: "[Diário] Caçador de Nineshark da Guilda Lua Minguante", detail: "Escolha de recompensa x1." },
      { type: "weekly", label: "[Semanal] Caçador de Nineshark", detail: "Escolha de recompensa x1." },
  ...
  },
  {
    ...
    sources: [
      ...
      { type: "daily", label: "[Diário] Caçador de Dente de Aço Negro da Guilda Lua Minguante", detail: "Escolha de recompensa x1." },
      { type: "weekly", label: "[Semanal] Caçador de Dente de Aço Negro", detail: "Escolha de recompensa x1." },
      { type: "crow", label: "Loja de Moeda Corvo", detail: "Comprar com Lavinia, no Ninho do Corvo." },
    ],
  },
  {
